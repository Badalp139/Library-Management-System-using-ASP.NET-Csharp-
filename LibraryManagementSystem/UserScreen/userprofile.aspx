                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFullName" ErrorMessage="Please Enter Your Name" ForeColor="Red" ValidationGroup="profile"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDOB" ErrorMessage="Please Enter Your DOB" ForeColor="Red" ValidationGroup="profile"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter Your ContactNo" ForeColor="Red" ValidationGroup="profile" ControlToValidate="txtContact"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Enter Your EmailId" ForeColor="Red" ValidationGroup="profile" ControlToValidate="txtEmail"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please Enter Your State" ForeColor="Red" ValidationGroup="profile" ControlToValidate="ddlState"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label>City</label>
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Please Enter Your City" ForeColor="Red" ValidationGroup="profile" ControlToValidate="txtCity"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label>Pincode</label>
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Enter Your Pincode" ForeColor="Red" ValidationGroup="profile" ControlToValidate="txtPincode"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Please Enter Your Address" ForeColor="Red" ValidationGroup="profile" ControlToValidate="txtFullAddress"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="row">
