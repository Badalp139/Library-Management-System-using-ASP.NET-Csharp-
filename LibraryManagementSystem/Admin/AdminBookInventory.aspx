<%@ Page Title="Book Inventory" Language="C#" MasterPageFile="~/Admin/Adminsite2.Master" AutoEventWireup="true" CodeBehind="AdminBookInventory.aspx.cs" Inherits="LibraryManagementSystem.Admin.AdminBookInventory" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <%--<img id="imgview" src="../imgs/book1.png" height="150" width="100" alt="" />--%>
                                    <asp:Image ID="ImgPhoto" ImageUrl="../Imgs/book1.png" runat="server" height="150" width="100" alt="" />
                                </center>
                            </div>
                        </div>
